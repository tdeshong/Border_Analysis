...
class TestBorderAnalytic(unittest.TestCase):
  ...
  def test_readFile(self):
    ...
    self.assertDictEqual(ordinary, expected)
    
    emptyCsv = main.readFile("Empty.csv")
    self.assertDictEqual(emptyCsv, {})
 ...
 def test_average(self):
    ...
    self.assertDictEqual(main.average(dict1, "US-Mexico Border"), expected1) 
    
    self.assertDictEqual(main.average(dict2, "US-Mexico Border"), expected2)
